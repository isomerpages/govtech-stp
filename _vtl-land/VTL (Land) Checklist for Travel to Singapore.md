...
<p style="font-size:18px; line-height:1.35; margin-top:0px; margin-bottom:10px; color:black;">Travellers arriving in Singapore <b>from 23 Jan 2022, 2359h</b>, via VTL (Air) or (Land) will perform an on-arrival test, and self-administered ART from Day 2 to 7 of their arrival.</p>
	</div>
