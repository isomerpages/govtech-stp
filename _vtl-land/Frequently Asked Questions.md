...
<label class="accordion" for="Australia-cert"><b>Australia</b></label>
...
<label class="accordion" for="Brunei-cert" ><b>Brunei Darussalam</b></label>
...
<label class="accordion" for="Cambodia-cert" ><b>Cambodia</b></label>
...
<label class="accordion" for="Canada-cert" ><b>Canada</b></label>
...
<label class="accordion" for="eudcc-cert" ><b>European Union Member States or non-EU countries that have joined the EU DCC system (listed <a href="https://ec.europa.eu/info/live-work-travel-eu/coronavirus-response/safe-covid-19-vaccines-europeans/eu-digital-covid-certificate_en" target="_blank">here</a>)</b></label>
...
<label class="accordion" for="Fiji-cert" ><b>Fiji</b></label>
...
<label class="accordion" for="India-cert"><b>India</b></label>
...
<label class="accordion" for="Indonesia-cert"><b>Indonesia</b></label>
...
<label class="accordion" for="Malaysia-cert"><b>Malaysia</b></label>
...
<label class="accordion" for="Maldives-cert"><b>Maldives</b></label>
...
<label class="accordion" for="ROK-cert"><b>Republic of Korea</b></label>
...
<label class="accordion" for="SriLanka-cert"><b>Sri Lanka</b></label>
...
<label class="accordion" for="Thailand-cert" ><b>Thailand</b></label>
...
<label class="accordion" for="UK-cert"><b>United Kingdom</b></label>
		<div class="content" style="background-color:#ededed;">
			<ol style="list-style-type:lower-alpha; ">
...
<label class="accordion" for="USA-cert"><b>United States of America</b></label>
...
#### 4. How do I prove my vaccination status when applying for a VTP (Land) if: 
...
Please check if your Singapore vaccination records are valid through <a href="http://go.gov.sg/health-cert-query" target="_blank">this link</a> and, if necessary, re-tag your records to your most updated identification (e.g. passport/FIN/IC) number.  The retagging process is not immediate. Please attempt to resubmit a VTP (Land) application <b>only after</b> receiving confirmation from the Ministry of Health / Health Promotion Board that your records have been successfully retagged.
...
All other travellers, except children aged 2 or below, are not exempted from the on-arrival test requirement.
...
To step up detection and containment of the Omicron variant until more information is available, we are requiring travellers to undergo post-arrival ARTs.
...
#### 8. Are there specific ART kits that travellers may use for self-testing?
...
#### 9. How much does an ART kit cost?
...
#### 10. How do travellers self-administer an ART?
...
#### 11. Are there any age restrictions on the use of ART kits?
...
#### 12. How do travellers submit their test results?

Travellers are not required to submit their test results.

#### 13. How long will it take to obtain the results of the self-administered ART?
...
<i>General FAQs on TraceTogether can be found <a href="https://support.tracetogether.gov.sg/hc/en-sg" target="_blank">here</a>.</i>
