...
<div id="ltph" class="content" style="background-color:#edf4fa;">
	...
	<p style="line-height:1.4; margin-top:20px; font-size:18px; ">Please note the following before applying:
		<ol style="margin-top:0px; list-style-type:disc;">
			...
			<li style="font-size:18px; margin-top:10px; margin-bottom:0px; line-height:1.4;"><b>VTP (Land) applications are open for travellers intending to enter Singapore 3-60 days after today. Travellers entering Singapore after this date range should come back on a later date to apply.</b>.</li>
			<li style="font-size:18px; margin-top:10px; margin-bottom:0px; line-height:1.4;">A VTP is valid for 6 calendar days from the traveller’s chosen date of entry.</li>
