...
<div style="padding-left: 5px; padding-bottom: 20px; margin-bottom:20px; font-size:16px; line-height:1.0; color:black; border-style: solid; border-width: 1px;">
	...
	<p style="font-size:16px; margin-top:20px; margin-bottom:0px; line-height:1.4;"><b>From 19 December 2021, 2359hrs</b>, Malaysia Citizens and Permanent Residents who are <b>not</b> Singapore-issued Long-Term Pass holders or Singapore Permanent Residents, will also be allowed to enter Singapore via VTL (Land). Applications for a Vaccinated Travel Pass (Land) [VTP (Land)] for these travellers will commence on <b>17 December 2021, 0800hrs.</b></p>
	</div>
...
<tbody>
		<tr>
<td style="font-size: 16px; border-left:1px solid #D8D8D8; border-right:1px solid #D8D8D8;border-top:1px solid #D8D8D8; border-bottom:1px solid #D8D8D8; background-color:#eceeef;">Non-Malaysian male Work Permit or S Pass workers in the Construction, Marine shipyard or Process (CMP) sector</td>
		<td style="font-size: 16px; border-left:1px solid #D8D8D8; border-right:1px solid #D8D8D8;border-top:1px solid #D8D8D8; border-bottom:1px solid #D8D8D8; background-color:#eceeef;"><a href="https://www.mom.gov.sg/covid-19/actions-for-companies-to-bring-pass-holders-into-singapore#request-for-moms-entry-approval-for-cmp-workers" target="_blank">MOM’s entry approval</a> or <a href="https://www.scal.com.sg/" target="_blank">ongoing industry initiatives for the CMP sectors</a></td>
</tr>
			<tr>
<td style="font-size: 16px; border-left:1px solid #D8D8D8; border-right:1px solid #D8D8D8;border-top:1px solid #D8D8D8; border-bottom:1px solid #D8D8D8; background-color:#eceeef;">Workers staying in dormitories</td>
		<td style="font-size: 16px; border-left:1px solid #D8D8D8; border-right:1px solid #D8D8D8;border-top:1px solid #D8D8D8; border-bottom:1px solid #D8D8D8; background-color:#eceeef;"><a href="/wphl/overview" target="_blank">Work Pass Holder Lane</a></td>
</tr>
	</tbody>
	</table>
...
<p style="line-height:1.4; font-size:18px; ">Travellers must belong to any of the following categories:
	<ol style="list-style-type:lower-alpha">
		...
		<li style="line-height:1.4; margin-top:10px; margin-bottom:0px; font-size:18px;">Malaysia Citizen <span style="color:red;"><b>[From 19 Dec 2021, 2359hrs]</b></span> </li>
		<li style="line-height:1.4; margin-top:10px; margin-bottom:0px; font-size:18px;">Malaysia Permanent Resident <span style="color:red;"><b>[From 19 Dec 2021, 2359hrs]</b></span> </li>
	</ol>
	</p>
...
<div id="criteria2" class="content" style="background-color:#edf4fa;">
	...
	<p style="line-height:1.4; font-size:18px; ">Children who are 12 and below in this calendar year and are unvaccinated can still travel to Singapore via VTL (Land) <b>if</b> accompanied by a fully vaccinated VTL traveller. However, the child must be a Singapore Citizen, Singapore Permanent Resident, holder of a Singapore-issued Long-Term Pass, Malaysia Citizen, or Malaysia Permanent Resident.</p>
	</div>
...
<div id="ltph" class="content" style="background-color:#edf4fa;">
	...
	<p style="line-height:1.4; font-size:18px; ">Malaysian Ciziens and Prs who do not hold a Singapore-issued long-term pass or are not Singapore PRs may only apply for a VTP Land from <b>17 December 2021, 0800hrs</b></p>
	<p style="line-height:1.4; margin-top:20px; font-size:18px; ">Please note the following before applying:
		<ol style="margin-top:0px; list-style-type:disc;">
			...
			<li style="font-size:18px; margin-top:10px; margin-bottom:0px; line-height:1.4;">VTP applications are open for travellers entering Singapore <b>3-9 days after today</b>, and VTPs are valid for up to 14 calendar days from the traveller's chosen date of entry. Travellers not trvelling during this date range can apply for a VTP later.</li>
...
<ol style="font-size:18px; list-style-type:disc;">
	...
	<li style="font-size:18px; line-height:1.4;"><a target="_blank" href="/vtl-land/faq#PDT">Pre-departure test for travel to Singapore</a></li>
