...
<div id="top"></div>
<div id="notes" style="width:104.1px; border-left: 2px solid red; border-top: 2px solid red; border-bottom: 2px solid red; border-right: 2px solid red; margin-bottom:20px;">
...
margin-left:50px;
		...
		<body>
<div style="padding-left: 5px; margin-bottom:20px; font-size:18px; line-height:1.0; border-style: solid; border-width: 2px; border-color:red; width:104.1%; ">
...
<table style="width:114%;">
  <tbody>
 <tr>
	    <td style="margin-top:0px; margin-bottom:0px; font-size:18px; width:73px; padding-left:0px; padding-right:0px; text-align:right;"><b>Step 1</b></td>
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color: #102a40; border-left:10px #102a40; color:white; font-size:18px; width:104.1%;">&#9634;&nbsp; <b>Step 2:  Obtain additional entry documents (if required)</b></div>
<div style="padding:10px 10px 5px 10px; margin-bottom:10px; line-height:1.35; border-left:2px solid #adadad;border-right:2px solid #adadad;border-top:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:104.1%;">
...
<div id="1C" style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color: #102a40; border-left:10px #102a40; color:white; font-size:18px; width:104.1%;">&#9634;&nbsp;<b>Step 3: Fill SG Arrival Card up to 3 days before arrival </b></div>
<div style="padding:10px 10px 5px 10px; margin-bottom:10px; line-height:1.35; border-left:2px solid #adadad;border-right:2px solid #adadad;border-top:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:104.1%;">
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color: #102a40; border-left:10px #102a40; color:white; font-size:18px; width:104.1%;">&#9634;&nbsp;<b>Step 5: Local Health Protocols & Maintenance of Vaccination Status</b></div>
 ...
 <thead>
    <tr>
     <th style="margin-top:0px; margin-bottom:0px; font-size:18px;border-left:2px solid #E0E0E0;border-right:2px solid #E0E0E0;border-top:2px solid #E0E0E0; background-color:#153854; color:white; width:100px;"><b>Vaccine Brand / Manufacturer</b></th>
	     <th style="margin-top:0px; margin-bottom:0px; font-size:18px;border-left:2px solid #E0E0E0;border-right:2px solid #E0E0E0;border-top:2px solid #E0E0E0; background-color:#153854; color:white;"><b>MOH recommended Additional Vaccination Dose(s) for continued qualification of Vaccination-Differentiated Measures</b></th>
    </tr>
 </thead>
 <tbody>
    <tr>
