...
<div style="padding-left: 5px; margin-bottom:20px; font-size:18px; line-height:1.0; border-style: solid; border-width: 2px; border-color:red; width:104.1%; ">
	...
	<p style="font-size:18px; margin-top:10px; margin-bottom:0px;line-height:1.3;">Travellers born on or before 31 Dec 2009 who are medically ineligible for vaccination, not vaccinated or have recovered from COVID-19 without taking the minimum required WHO EUL vaccines are considered fully-vaccinated and should refer to the <a href="/arriving/general-travel/non-fully-vaccinated" target="_blank">checklist for non-fully vaccinated travellers</a> instead.</p>
