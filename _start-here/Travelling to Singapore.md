...
<p style="margin-top:20px; margin-bottom:20px; line-height:1.35;"><b>With effect from 22 December 2021, 2359hrs (SGT), there will be no new ticket sales on designated VTL (Air) flights for entry into Singapore from all VTL countries until 20 January 2022, 2359hrs (SGT). Travellers may still book tickets for flights arriving in Singapore from 21 January 2022 onwards if available.</b></p>
