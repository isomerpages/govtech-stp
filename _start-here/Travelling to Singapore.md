...
### This is the current set of codes for the arrival overview page
...
<table style="width:100%; overflow: visible;">
	<thead>
		...
		<tr>
		<th style="margin-top:0px; margin-bottom:0px; font-size:16px;border-left:2px solid #E0E0E0; border-top:2px solid #E0E0E0; border-right:2px solid #E0E0E0; background-color:#153854; color:white; width:10%"><b>Traveller Fully Vaccinated with WHO EUL COVID-19 Vaccines and Travellers Aged 12 and Below</b></th>
