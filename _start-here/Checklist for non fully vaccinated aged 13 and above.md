...
<div class="col is-8 is-offset-1-desktop is-12-touch print-content" style="margin-left:-30px; width:120%">
...
<p style="font-size:18px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:red;"><b><u>Instructions before use:</u></b></p>
  ...
  <ol style="padding-left:25px; list-style-type:disc;">
    <li style="padding-left:25px; font-size:18px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:black;"><b>Not</b> considered fully vaccinated against COVID-19 with WHO EUL vaccines*; <b>OR</b></li>
...
<body>
<ol class="custom-ol">
<li style="font-size:18px; line-height:1.35; white-space: normal;float: left;width: 100%; height: auto; word-wrap: break-word;"><a href="#stage1">Pre-Departure Requirements</a></li>
<li style="font-size:18px; line-height:1.35; white-space: normal;float: left;width: 100%; height: auto; word-wrap: break-word;"><a href="#stage2">Requirements on Arrival</a></li>
<li style="font-size:18px; line-height:1.35; white-space: normal;float: left;width: 100%; height: auto; word-wrap: break-word;"><a href="#stage3">Stay-Home Notice (Quarantine) and COVID-19 Testing Requirements</a></li>
<li style="font-size:18px; line-height:1.35; white-space: normal;float: left;width: 100%; height: auto; word-wrap: break-word;"><a href="#stage4">Comply with Local Health Protocols</a></li>
</ol>
	</body>
	</html>

  
<div id="stage1" style="background-color: #102a40; border-left:10px #102a40 solid; color: #FFFFFF; font-size: 18px; line-height: 28px; padding: 15px 20px 15px 20px; margin: 20px 0px 0px 0px;width:110%;"><b>Stage 1: Pre-Departure Requirements</b></div>

<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad; border-top:2px solid #adadad; border-right:2px solid #adadad; font-size:18px;width:110%;" id="1A">
&#9634; &nbsp;&nbsp;<b>1A) Obtain Entry Approval</b></div>
<div style="padding:10px 10px 10px 10px; margin-bottom: 0px; line-height:1.35; background-color:#f7f7f7; border-left:2px solid #adadad;border-right:2px solid #adadad; border-bottom:2px solid #adadad;font-size:18px;width:110%;">
...
<li style="padding-left:25px; font-size:18px; margin-top:10px; margin-bottom:0px;line-height:1.3;">Long-Term Pass holders (including In-Principle Approval holders) aged 13 to 17 (i.e. born between 2005 and 2010 inclusive) arriving <b>before 1 Jul 2022.</b></li>
	    ...
	    <p style="font-size:18px; margin-top: 10px; margin-bottom:20px; line-height:1.35;">The following types of travellers are generally <b>not allowed</b> to enter Singapore:</p>
	 <ol style="list-style-type: disc; padding-left:25px;">
...
<input id="yellowfever" type="checkbox">
    <label style="background-color: #CEDEED; color:#182657;" for="yellowfever"><b>Travellers arriving in Singapore from countries/regions in Africa and Latin America with Yellow Fever risk</b></label>
<div style="border-bottom: 2px solid #E0E0E0; border-left:2px solid #E0E0E0;border-right:2px solid #E0E0E0; background-color: #edf4fa;" class="content">
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad; border-right:2px solid #adadad; font-size:18px; width:110%;" id="1C">
&#9634; &nbsp;&nbsp;<b>1C) Fill SG Arrival Card up to 3 Days before Arrival</b></div>
<div style="padding:10px 10px 5px 10px; margin-bottom:0px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:110%;">
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad; border-right:2px solid #adadad; font-size:18px; width:110%;" id="1D">
&#9634; &nbsp;&nbsp;<b>1D) COVID-19 Pre-Departure Test (PDT)</b></div>
<div style="padding:10px 10px 20px 10px; margin-bottom:0px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:110%;">
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad; border-right:2px solid #adadad; font-size:18px; width:110%;" id="1E">&#9634; &nbsp;<b>1E) Secure Stay Home Notice (SHN) Accommodation for at least 7 days</b></div>

<div style="padding:10px 10px 20px 10px; margin-bottom:0px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:110%"><p style="line-height:1.35; font-size:18px;">You will be placed on 7-day Stay Home Notice (SHN) upon arrival. During this period, you will remain in your declared SHN accommodation for the full 7 days (see Stage 4 for details).</p>
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad; border-right:2px solid #adadad; font-size:18px; width:110%;" id="1F">&#9634;  <b>1F) Install and Activate TraceTogether</b></div>

<div style="padding:10px 10px 10px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:110%;">
...
<div id="stage2" style="background-color: #102a40; border-left:10px #102a40 solid; color: #FFFFFF; font-size: 18px; line-height: 28px; padding: 15px 20px 15px 20px;    margin: 20px 0px 0px 0px; width:110%;"><b>Stage 2: Arrival in Singapore</b></div>

<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad; border-right:2px solid #adadad; border-top:2px solid #adadad; font-size:18px; width:110%;">
&#9634; &nbsp;&nbsp;<b>2A) Immigration Clearance</b></div>
<div style="padding:10px 10px 5px 10px; margin-bottom:0px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; font-size:18px; width:110%;">
...
<div id="2B" style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad;border-right:2px solid #adadad; font-size:18px; width:110%;">
&#9634; &nbsp;&nbsp;<b>2B) Commute to declared Stay-Home Notice (SHN) accommodation</b></div>
<div style="padding:10px 10px 5px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; border-bottom:2px solid #adadad; font-size:18px; width:110%;">
...
<div id="stage3" style="background-color: #102a40; border-left:10px #102a40 solid; color: #FFFFFF; font-size: 18px; line-height: 28px; padding: 15px 20px 15px 20px;    margin: 20px 0px 0px 0px; width:110%;"><b>Stage 3: Stay-Home Notice (Quarantine) and COVID-19 Testing Requirements</b></div>

<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad;border-right:2px solid #adadad; border-top:2px solid #adadad; font-size:18px; width:110%;">
&#9634; &nbsp;&nbsp;<b>3A) Stay-Home Notice (SHN) Requirements</b></div>
<div style="padding:5px 10px 20px 10px; margin-bottom:0px; line-height:1.35; background-color:#f8f8f8; border-left:2px solid #adadad;border-right:2px solid #adadad; font-size:18px; width:110%;">
...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#4f728e; color: white; border-left:2px solid #adadad;border-right:2px solid #adadad; font-size:18px; width:110%;">
...
<div id="stage4" style="background-color: #102a40; border-left:10px #102a40 solid; color: #FFFFFF; font-size: 18px; line-height: 28px; padding: 15px 20px 15px 20px;    margin: 20px 0px 0px 0px; width:110%;"><b>Stage 4: Comply with Local Health Protocols</b></div>
