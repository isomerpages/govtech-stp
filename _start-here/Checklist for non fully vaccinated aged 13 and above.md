...
<p style="font-size:18px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:red;"><b><u>Instructions before use:</u></b></p>
	<p style="font-size:18px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:black;">This checklist is for all modes of arrival to Singapore via air, land or sea.</p>
...
<ol style="padding-left: 20px; font-size:18px; margin-bottom:0px; list-style-type:lower-alpha;">
	...
	<li style="padding-left: 20px; font-size:18px; margin-top:0px; margin-bottom:10px; line-height:1.35;">Administered by a trained professional; or</li>
			<li style="padding-left: 20px; font-size:18px; margin-top:0px; margin-bottom:10px; line-height:1.35;"><b>[<a href="https://go.gov.sg/remote-art-overseas-sg" target="_blank">Eligible travellers only (click for details)</a>]</b> Self-administered Antigen Rapid Test (ART) remotely supervised by an approved ART provider in Singapore.</li>
				</ol>
	</li>
	</ol>
...
<div style="padding:10px 10px 10px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; font-size:18px;">
	<p style="line-height:1.35; margin-bottom:10px; font-size:18px;">If you are a visitor and do not already have the TraceTogether contact tracing mobile application, install and activate <a href="https://www.tracetogether.gov.sg/" target="_blank">TraceTogether</a> mobile application using <a href="https://support.tracetogether.gov.sg/hc/en-sg/articles/1500002071841-I-m-travelling-to-Singapore-How-do-I-set-up-the-TraceTogether-App-" target="_blank">this guide</a>. Only travellers aged 6 or below this year are exempted from installing TraceTogether.</p>
