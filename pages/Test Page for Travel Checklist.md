...
<p style="padding:10px; margin-bottom:0px; line-height:1.5; background-color:#f8f8f8; font-size:18px;"><input type="checkbox" id="1C" name="1C" value="HealthDeclaration"><label for="1C">&nbsp;&nbsp;<b>(C) Submit Health Declaration</b></label><br><br>
