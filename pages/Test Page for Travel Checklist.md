...
<p style="padding: 10px; margin: 20px 0px 20px 0px; line-height:1.5; background:#f0f0f0; font-size:18px;"><input type="checkbox" id="1A" name="1A" value="EntryApproval"><label for="1A">&nbsp;&nbsp;<b>(B) Apply for Entry Visa (For holders of passports issued by visa-required country/region)</b></label><br><br>
