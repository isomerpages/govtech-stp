...
<p style="padding:10px; margin-bottom:0px; line-height:1.5; background-color:#f8f8f8; font-size:18px;"><input type="checkbox" id="1C" name="1C" value="HealthDeclaration"><label for="1A">&nbsp;&nbsp;<b>(C) Submit Health Declaration</b></label><br><br>
Up to 72 hours before arrival in Singapore, travellers should submit an <a href="https://eservices.ica.gov.sg/sgarrivalcard/" target="_blank">SG Arrival Card (SGAC)</a> with their pre-trip health and travel history declaration here. Travellers should **defer their travels** if they experience any of the following conditions:<ol style="font-size:18px; margin-top:0px; margin-bottom:0px; list-style-type:lower-roman; background-color:#f8f8f8;">
