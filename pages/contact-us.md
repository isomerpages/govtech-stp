...
<p style="font-size:16px; margin-top:0px; margin-bottom:0px; line-height:1.2;">New entry approvals have been reduced or halted until further notice for short term visitors and long term pass holders with travel history to higher-risk countries/regions [i.e. all countries/regions, except Brunei, Hong Kong, Macao, Mainland China (excluding Jiangsu province), and New Zealand]. <b>If you are unable to select an entry date in the SafeTravel application portal, please defer your travel plans until the situation has stabilised</b>.</p>
