...
<label for="CountryListCat1">Category (I) Countries/Regions (based on 14-day travel history excluding transits)</label>

<div class="content">
<b>Hong Kong, Macao, Mainland China, Taiwan</b><br><br>

<!----Cat1 Helpers and CNs-->
<input type="checkbox" id="Helpers/CNs-1" />
<label for="Helpers/CNs-1" style="background:#5b5b5b;">Helpers/CNs arriving from Category (I) countries/regions</label>
...
<label for="OtherWorkPassHolders-1" style="background:#5b5b5b;">All Other Pass Holders arriving from Category (I) countries/regions</label>
...
<sup>4</sup> Including the Crown Dependencies (Guernsey, Isle of Man, and Jersey), and all British Overseas Territories.<br>
	<sup>5</sup> Including the US territories of American Samoa, Northern Mariana Islands, Guam, Puerto Rico and US Virgin Islands.<br><br>

<!----Cat2 Helpers and CNs-->
<input type="checkbox" id="Helpers/CNs-2" />
<label for="Helpers/CNs-2" style="background:#5b5b5b;">Helpers/CNs arriving from non-VTL Category (II) countries/regions</label>
...
<label for="OtherWorkPassHolders-2" style="background:#5b5b5b;">All Other Pass Holders arriving from non-VTL Category (II) countries/regions</label>
...
<label for="CountryListCat3">Category (III) Countries/Regions (based on 14-day travel history excluding transits)</label>

<div class="content">
<b>Argentina, Bangladesh, Belarus, Brazil, Chile, Colombia, Estonia, Ethiopia, India, Kuwait, Laos, Latvia, Lithuania, Mexico, Mongolia, Myanmar, Nepal, Oman, Pakistan, Papua New Guinea, the Philippines, Romania, Russia, Serbia, Seychelles, Slovenia, Sri Lanka, Thailand and Ukraine</b><br><br>

<!----Cat3 Helpers and CNs-->
<input type="checkbox" id="Helpers/CNs-3" />
<label for="Helpers/CNs-3" style="background:#5b5b5b;">Helpers/CNs arriving from Category (III) countries/regions</label>
...
<label for="OtherWorkPassHolders-3" style="background:#5b5b5b;">All Other Pass Holders arriving from Category (III) countries/regions</label>
...
<label for="CountryListCat4">Category (IV) Countries/Regions (based on 14-day travel history excluding transits)</label>

<div class="content">
<b>All Other Countries</b><br><br>

<!----Cat4 Helpers and CNs-->
<input type="checkbox" id="Helpers/CNs-4" />
<label for="Helpers/CNs-4" style="background:#5b5b5b;">Helpers/CNs arriving from Category (IV) countries/regions</label>
...
<label for="OtherWorkPassHolders-4" style="background:#5b5b5b;">All Other Pass Holders arriving from Category (IV) countries/regions</label>
