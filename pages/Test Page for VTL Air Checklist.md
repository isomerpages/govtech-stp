...
<p style="font-size:18px;"><span style="font-size:32px; color:green;"><b>&#10003;</b></span>&nbsp; Short-term Visitor (i.e. who do not belong to any of the categories above)</p>
<p style="font-size:18px;"><span style="color:red; font-size:32px;">&#9888;</span>&nbsp; <b>[If ALL applicable requirements below are not met]</b> Singapore Citizens/Permanent Residents will be subjected to prevailing Stay-Home Notice and testing requirements. All other travellers may be denied entry into Singapore. If you are not eligible for the VTL, refer to the <a href="/arriving/overview" target="_blank">Travelling to Singapore</a> page for the available non-VTL lanes.</p>
...
<label for="1A">&nbsp;&nbsp;<b>(A) Obtain an accepted proof of vaccination</b></label>
<p style="font-size:18px; margin-bottom:10px; line-height:1.5; margin-top:0px;">Travellers must obtain any of the following acceptable proofs of vaccination to be eligible for the VTL. Note the requirements of each vaccination proof during application, airline check-in and immigration clearance, based on their countries of issuance.</p>
