...
<p style="font-size:18px; margin-top: 10px; margin-bottom:20px; line-height:1.35;">You can show proof of vaccination via the TraceTogether mobile application. If you were vaccinated overseas, your vaccination status only lasts up to 30 days, or when you leave Singapore, whichever is earlier. For extended stays in Singapore, visit a <a href="https://flu.gowhere.gov.sg/" target="_blank">Public Health Preparedness Clinic</a> to register your vaccination status into the National Immunisation Registry (NIR). A booster vaccination dose may also be required.</p>
