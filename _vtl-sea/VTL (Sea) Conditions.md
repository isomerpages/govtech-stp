...
<ol style="font-size:20px;">
  ...
  <li style="font-size:20px; list-style-type:decimal;"> A VTL (Sea) traveller must comply with the following conditions:
     <ol style="font-size:18px; list-style-type:upper-alpha;">
	     ...
	     <li style="font-size:18px; list-style-type:upper-alpha;">have only travelled to / transited via any <a href="/vtl/requirements-and-process#countries">VTL (Sea) countries/regions</a>, <a href="/shn-and-swab-summary" target="_blank">Category I countries/regions</a> and/or Singapore, for the last 7 consecutive days<sup>2</sup> before departing for Singapore;</li>			 
