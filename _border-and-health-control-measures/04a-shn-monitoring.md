...
For Frequently Asked Questions (FAQs) on the ICA issued device, click [here](). Otherwise, click [here]() for the MOM issued device.
...
<table>
  ...
  <tbody>
    <tr>
      <td  style="font-size:20px; margin-top:0px; margin-bottom:0px;">ICA’s wristband device users are to remove and dispose them based on existing e-waste disposal methods < href="https://www.nea.gov.sg/our-services/waste-management/3r-programmes-and-resources/e-waste-management/where-to-recycle-e-waste">here</a>. <br/><br/> ICA officers will contact the user to collect the gateway device issued by ICA. Please do not dispose the gateway device.</td>
