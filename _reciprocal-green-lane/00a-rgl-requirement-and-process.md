...
<thead>
  <tr>
    <th style="font-size:18px; border-top:3px solid #D8D8D8; border-right:1px solid #D8D8D8;">Brunei, China (Chongqing, Guangdong, Jiangsu, Shanghai, Tianjin and Zhejiang), Germany, Japan, Malaysia, Republic of Korea</th>
    <th style="font-size:18px; border-top:3px solid #D8D8D8;">Indonesia</th>
  </tr>
</thead>
<tbody>
  <tr>
   <td style="font-size:18px; border-bottom:1px solid #D8D8D8; border-right:1px solid #D8D8D8;">Be a resident holding a valid passport of any nationality </td>
   <td style="font-size:18px; border-bottom:1px solid #D8D8D8;">Be a citizen of Indonesia </td>
 </tr>
 </tbody>
 </table>
...
<thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>At least 14 calendar day</u></b> before planned date of entry into Singapore</th>
    <!-- <th>Scenarios</th>
...
<tbody>
  <tr>
    ...
    <td style="font-size:18px;"><b>Singapore-based companies or Singapore Government Agencies (i.e. application sponsors) to submit an RGL application <a href="/rgl/apply-now">here</a>.</b> Applications for travel are open between 2-5 weeks before the intended date of entry, and processing of the application can take up to 7 calendar days excluding the day of application. <b> Applications submitted less than 7 days from the intended date of entry will not be processed. </b>
     <p style="font-size:18px; margin-top:0px; margin-bottom:opx;">  Application sponsors should: </p>
      ...
      <li style="font-size:16px; margin-top:0px; margin-bottom:0px;  "> Traveller’s passport details, FIN number (if applicable) and Long Term Pass expiry date (if applicable); </li>
      <li style="font-size:16px; margin-top:0px; margin-bottom:0px;"> Traveller’s intended date of entry into Singapore; </li>
      <li style="font-size:16px; margin-top:0px; margin-bottom:0px;"> Traveller's intended date of entry into Singapore;</li>
      <li style="font-size:16px; margin-top:0px; margin-bottom:0px;"> Address of Traveller’s accommodation to complete on-arrival isolation (approximately 48 hours); </li>
      <li style="font-size:16px; margin-top:0px; margin-bottom:0px;"> Details of contact person in company or agency (e.g. name, mobile number, email address); and</li>
          <li style="font-size:16px; margin-top:0px; margin-bottom:0px;">Details of 14-day itinerary in Singapore.* </li>
      </ol>      
       </li>
        <p style="font-size:18px;"> * RGL travellers from Indonesia are required to submit their 10-day itinerary. </p>     
  ...
  <thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>At least 7 days </u></b> before planned date of entry into Singapore</th>
  </tr>
  </thead>
  <tr>
...
<thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>3 Calendar Days</u></b> before planned date of entry into Singapore</th>
    <!-- <th>Scenarios</th>
   <th>Charging Policy for C+ treatment</th> -->
  </tr>
</thead>
<tbody>
  <tr>
    <td style="font-size:18px;"><b>Pre-departure COVID-19 Polymerase Chain Reaction(PCR) Test</b></td>
 ...
 <tr>
    ...
    <td style="font-size:18px;"><b> Approved RGL travellers should monitor their health and avoid travelling if feeling unwell. If the traveller is healthy, they should: </b>
      <ol style="margin-top:0px; list-style-type: lower-alpha;">
   ...
   <thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>Day of Departure</u></b> to Singapore 
       </th>
  </tr>
  </thead>
   <tr>
    <td style="font-size:18px;"><b>Pre-departure/ Pre-boarding clearance</b></td>
    <td style="font-size:18px;"><b>Approved RGL travellers must produce the following documents when leaving for Singapore: </b>
   <ol style="margin-top:0px;">
...
<tbody>
  <tr>
    ...
    <td style="font-size:18px;"><b>An approved RGL traveller must declare on arrival that he/she is an approved SafeTravel pass holder and be able to produce the following:</b>
      ...
      <li style="font-size:16px; margin-top:0px; margin-bottom:0px;">Valid SafeTravel Pass for the intended week of travel;</li>
             ...
             <li style="font-size:16px; margin-top:0px; margin-bottom:0px;">Negative COVID-19 PCR test result; and</li>
             <li style="font-size:16px; margin-top:0px; margin-bottom:0px;">A return air ticket.</li>
      </ol> 
     <p style="font-size:18px; margin-top:0px; margin-bottom:0px;">Upon confirmation of his/her traveller scheme, the traveller will take a COVID-19 PCR test at the airport/land or sea checkpoint. Travellers that have yet to pay for their post-arrival COVID-19 PCR test will be made to pay on the spot.</p>
      </td>
  </tr>
  <tr>
    <td  style="font-size:18px;"><b>Transport from Checkpoint to Accommodation</b></td>
    <td style="font-size:18px;">The local host* must arrange for transport for the traveller to commute directly from the immigration checkpoint to the declared self-sourced accommodation. Use of public transport is not allowed. 
      </td>
  </tr>
  <tr>
...
### 5. Post-Arrival
 ...
 <thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>Up to 2 days after arriving</u></b> in Singapore 
       </th>
  </tr>
  </thead>
<tbody>
<tr>
  ...
  <thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>After completion of isolation </u></b>
       </th>
  </tr>
  </thead>
   <tr>
    <td style="font-size:18px;"><b>Safe Travel within Singapore</b></td>
    <td style="font-size:18px;"><b>All approved RGL travellers must:</b>
    <ol style="margin-top:0px;">
...
<thead>
  <tr>
    <th colspan="2" style="font-size:18px;"><b><u>Up to 14 days after departure </u></b> from Singapore</th>
    <!-- <th>Scenarios</th>
   <th>Charging Policy for C+ treatment</th> -->
  </tr>
</thead>
