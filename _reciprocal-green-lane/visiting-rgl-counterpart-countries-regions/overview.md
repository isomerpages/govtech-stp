...
<div id="notes" style="border-left: 2px solid red; border-top: 2px solid red; border-bottom: 2px solid red; border-right: 2px solid red; margin-bottom:20px;">
	...
	<p style="color:red; line-height:1.35; font-size:18px; margin-bottom:5px; margin-top:10px;">RGL information for travelling out of Singapore has moved permanently to <a href="https://www.ica.gov.sg/enter-transit-depart/entering-singapore/safe-travel-lanes/reciprocal-green-lane/outbound" target="_blank">ICA’s RGL page</a>.</p>
