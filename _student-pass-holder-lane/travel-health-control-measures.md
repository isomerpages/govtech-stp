...
---
<i>This page provides info on travel health control measures (e.g. COVID-19 tests, Stay Home Notice) that apply to travellers entering Singapore via the Student’s Pass Holder Lane (STPHL). If this is not what you are looking for, you can click <a href="/stpl/overview">here</a> for the STPHL eligibility criteria, or <a href="/stpl/requirements-and-process">here</a> for the step-by-step pre-departure and entry guide for STPHL-travellers.</i>

### Travel Health Control Measures for STPHL-Travellers

The table below reflects the latest travel health control measures applicable to all approved STPHL-travellers (inclusive of announcements made on <b><u>12 Aug 2021</u></b>). To view all travel-related announcements, click <a href="/news-and-media/press-releases/">here</a>.
...
<p style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;"><sup>*</sup><i>To qualify to serve their SHN at their place of residence, travellers must satisfy the following conditions:</i></p>
<ol style="margin-top:0px; list-style-type: lower-roman;">
...
<p style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;"><sup>**</sup><i>SDF opt-out applications can be submitted via the SafeTravel application portal when applying for entry into Singapore, <b>from 20 Aug, 2359 hours</b> . To qualify, the traveller must remain in any of the countries/regions listed at S/N 1 to 4 of this table for 21 consecutive days before arrival in Singapore <u>and</u> meet either conditions below.</i></p>
<ol style="margin-top:0px; list-style-type: lower-roman;">
...
(includes those who had received prior approvals for entry)
	...
	<tr>
<td style="font-size:16px;border-top:3px solid #D8D8D8; border-right:1px solid #D8D8D8; background-color:#EDEDED; border-left:1px solid #D8D8D8;" colspan="2"><u>S/N 6a</u><br>
<ul style="margin-top:0px; list-style-type: disc;">
