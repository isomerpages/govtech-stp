...
<p style= "font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;"><sup>**</sup><i>SDF opt-out applications can be submitted via the SafeTravel application portal when applying for entry into Singapore, <b>from 20 Aug, 2359 hours</b><!--via <a href="https://go.gov.sg/scproptout">this form</a>--> . To qualify, the traveller must remain in any of the countries/regions listed at S/N 1 to 4 of this table for 21 consecutive days before arrival in Singapore <u>and</u> meet either conditions below.</i></p>
<ol style="margin-top:0px; list-style-type: lower-roman;">
