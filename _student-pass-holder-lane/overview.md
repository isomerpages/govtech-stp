...
The table below provides a quick overview of the key STPHL features, requirements as well as application and entry instructions. Travellers who are not eligible for entry via the STPHL may return to <a href="/arriving/overview">this menu</a>  to explore other Safe Travel options.
...
<td style="font-size:16px;border-right:1px solid #D8D8D8; vertical-align:middle;">Eligible travellers
</td>
</tr>
<tr>
...
<td style="font-size:16px;border-left:1px solid #D8D8D8;border-bottom:1px solid #D8D8D8; border-right:1px solid #D8D8D8;  background-color:#EDEDED;"><b>How and Where To Apply</b></td>
	<td style="font-size:16px;border-left:1px solid #D8D8D8;border-bottom:1px solid #D8D8D8; border-right:1px solid #D8D8D8;">INSERT TABLE HERE
<table>
	<thead>
		<tr>
...
<td style="font-size:16px;border-right:1px solid #D8D8D8;">Click <a href="/stpl/entry-guide">Here</a></td>
</tr>
</tbody>
	<thead>
<tr>
...
<td style="font-size:16px;border-right:1px solid #D8D8D8;"><p style="font-size:16px; line-height: 1.5;">Click here for the FAQ related to STPHL, or click the links below for specific queries on the following topics:</p>
