...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2">Applications are open between <b>7 to 20 clear working days</b> before your intended date of entry. Please note that the processing of the application can take up to <b>7 working days</b>. You are encouraged to apply for the SafeTravel Pass as early as possible, factoring in the time necessary for pre-departure measures.</td>
    </tr>
  </tbody>
</table>
