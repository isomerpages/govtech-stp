...
sections:
    - hero:
        title: <h3 style="color:black; width:700px; margin-top:0px; margin-bottom:180px; margin-left:120px; text-align:center;font-size:20px;">Singapore has implemented international Safe Travel Lanes to facilitate travel in and out of Singapore, while safeguarding public health amidst the <br/> COVID-19 pandemic. <br/><br/> Click the buttons below for the latest information on Safe Travel arrangements for arrival, transit or departure.</h3>
