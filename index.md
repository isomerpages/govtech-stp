...
sections:
  - hero:
      title: <h3 style="font-size:20px; font-weight:bold; font-family:Arial; letter-spacing:0; line-height:1.35em; color:#333; margin-bottom:-50px; margin-top:-50px;">Singapore has reopened to travellers who are fully vaccinated against COVID-19. <br/><br/> Click the buttons below for the latest travel requirements and advisories for arrival, transit or departure.</h3>
