...
RGL travellers are only allowed to travel to Singapore via a non-stop, direct flight from selected airports (below) in the counterpart countries/regions; transits through another country is prohibited.
...
All RGL travellers are required to take a COVID-19 Polymerase Chain Reaction test (“PCR test”). Travellers entering Singapore by air are encouraged to [pre-register and pre-pay](https://safetravel.changiairport.com/) for the PCR test, while travellers entering Singapore via land will pay on the day of arrival. Click [here](/health/covid19-tests/pcrtest) for more information on the tests and corresponding cost.
