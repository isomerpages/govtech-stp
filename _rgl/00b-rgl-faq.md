...
RGL travellers are only allowed to travel to Singapore via a non-stop flight from selected airports (below) in the counterpart countries/regions; transits through another country is prohibited.
