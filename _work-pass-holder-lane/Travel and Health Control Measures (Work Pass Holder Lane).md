...
<ol style="padding-left:20px; font-size:20px; margin-top:0px; margin-bottom:0px; line-height:1.5; list-style-type:lower-latin;">
	<li style="font-size:20px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Categories of travel health control measures for arrivals <a href="#from">from 7 Jan 2022, 2359 hours</a></li> 
	<li style="font-size:20px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Categories of travel health control measures for arrivals <a href="#before-1">before 7 Jan 2022, 2359 hours</a></li>
	</ol>
...
### Travel Health Control Measures for WPHL-Pass Holders [for arrivals from 7 Jan 2022, 2359 hours]

<span style="color:red;"><b>Travellers arriving in Singapore before 7 Jan 2022, 2359 hours will be subject to the health measure stipulated in their approval letters and Stay Home Notices (SHN).</b></span>
...
### Travel Health Control Measures for WPHL-Pass Holders [for arrivals before 7 Jan 2022, 2359 hours]
...
<td style="font-size:16px; border-top: 3px solid #D8D8D8; border-right:1px solid #D8D8D8; border-left:1px solid #D8D8D8; background-color:#5e5e5e; color:white; text-align:center; vertical-align:middle; border-bottom: 3px solid #D8D8D8;"><b>Hong Kong, Macao, Mainland China and Taiwan</b></td>
	...
	<td>
<!--Cat1 Countries-->
<input type="checkbox" id="CountryListCat1-bef" />
<label for="CountryListCat1-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for Helpers/Confinement Nannies (CNs)</b></label>
...
<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Proceed from the checkpoint <b>immediately</b> to their place of isolation. <br><br> Submitters must arrange to pick them up <b>within 1 hour of arrival</b> from the checkpoint, using private transport (e.g. employer's own vehicle, taxi, private hire car) to go to the place of isolation. Public transport (e.g. public bus or train) is <b>not allowed</b>.</li>
	...
	<!--Cat1 Other Work Pass Holders-->
	<input type="checkbox" id="OtherWorkPassHolders-1-bef" />
<label for="OtherWorkPassHolders-1-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for All Other Pass Holders</b></label>
...
<td style="font-size:16px; border-top: 3px solid #D8D8D8; border-bottom: 3px solid #D8D8D8; color:black; text-align:center; vertical-align:middle;"><b>Click to expand the health measures by Pass Type</b></td></tr>
	...
	<td>
<!--Cat2 Helpers/CNs-->
<input type="checkbox" id="CountryListCat2-bef" />
<label for="CountryListCat2-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for Helpers/Confinement Nannies (CNs)</b></label>
...
<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Serve a 7-day <a href="/health/shn">SHN</a> in one of the following: 
	...
	<!--Cat2 Other Work Pass Holders-->
	<input type="checkbox" id="OtherWorkPassHolders-2-bef" />
<label for="OtherWorkPassHolders-2-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for All Other Pass Holders</b></label>
...
<td style="font-size:16px; border-top: 3px solid #D8D8D8; border-bottom: 3px solid #D8D8D8; color:black; text-align:center; vertical-align:middle;"><b>Click to expand the health measures by Pass Type</b></td></tr>
	...
	<td>
<!--Cat3 Helpers and CNs-->
<input type="checkbox" id="CountryListCat3-bef" />
<label for="CountryListCat3-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for Helpers/Confinement Nannies (CNs)</b></label>
...
<ol style="margin-top: 0px; list-style-type: disc;">
	...
	<!--Cat3 Other Work Pass Holders-->
	<input type="checkbox" id="OtherWorkPassHolders-3-bef" />
<label for="OtherWorkPassHolders-3-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for All Other Pass Holders</b></label>
<div class="content" style="background-color:#f8f8f8;">
<ol style="margin-top: 0px; list-style-type: decimal;">
<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Must be <b><a href="/wphl/vaccination-requirements">fully vaccinated</a> before arrival.</b></li>
<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Take <b>1</b> of these COVID-19 tests <b>within 2 days before departure</b>:
...
<td style="font-size:16px; border-top: 3px solid #D8D8D8; border-bottom: 3px solid #D8D8D8; color:black; text-align:center; vertical-align:middle;"><b>Click to expand the health measures by Pass Type</b></td></tr>
	...
	<td>
<!--Cat4 Helpers and CNs-->
<input type="checkbox" id="CountryListCat4-bef" />
<label for="CountryListCat4-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for Helpers/Confinement Nannies (CNs)</b></label>
<div class="content" style="background-color:#f8f8f8;">
<ol style="margin-top: 0px; list-style-type: decimal;">
		<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Must be <b><a href="/wphl/vaccination-requirements">fully vaccinated</a> before arrival</b>.
</li>
...
<ol style="margin-top: 0px; list-style-type: disc;">
	...
	<!--Cat4 Other Work Pass Holders-->
	<input type="checkbox" id="OtherWorkPassHolders-4-bef" />
<label for="OtherWorkPassHolders-4-bef" style="background:#D8D8D8; color:#000000;"><b>Health Measures for All Other Pass Holders</b></label>
<div class="content" style="background-color:#f8f8f8;">
<ol style="margin-top: 0px; list-style-type: decimal;">
	<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Must be <b><a href="/wphl/vaccination-requirements">fully vaccinated</a> before arrival.</b></li>
<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Take a COVID-19 PCR test <b>within 2 days before departure</b> at an <a href="https://www.moh.gov.sg/covid-19/accreditation-bodies-for-covid-19-testing">internationally accredited or recognised lab, clinic or medical facility</a>. ART are <b>not allowed</b></li>
