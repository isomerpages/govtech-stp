...
<li style="font-size: 16px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Take a supervised self-swab (SSS) ART at a <a href="http://www.moh.gov.sg/covid-19/covid-19/quick-test-centres-(qtcs)" target="_blank">Quick Test Centre (QTC) or Combined Test Centre (CTC)</a> <b>within 24 hours</b> of arrival. To book the SSS ART, they can use the weblink in the Testing Notice (issued upon arrival). The test costs $15 (inclusive of GST) and payment is to be made at the test centre, using cashless modes (Mastercard, NETS, PayNow and Visa).</li>
