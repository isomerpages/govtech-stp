...
<div style="padding-left: 5px; margin-bottom:20px; font-size:16px; line-height:1.0; color:red; border-style: solid; border-width: 1px;">
	...
	<ol style="list-style-type:disc;">
		...
		<ol style="list-style-type:disc;">
			<li style="font-size:16px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:red;"><b>Fully vaccinated pass holders and non-fully vaccinated pass holders aged 12 and below</b> entering Singapore should refer to the <a href="/greenlist-fully-vaccinated" target="_blank">Green List Requirements for Vaccinated Travellers</a></li>
			<li style="font-size:16px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:red;"><b>Non-fully vaccinated pass holders aged 13 and above should refer to the <a href="/greenlist-non-fully-vaccinated" target="_blank">Green List Requirements for Non-Fully Vaccinated Travellers</a></li>
				</ol>
		</li>
	</ol>
	</p>
