...
<ol style="margin-top:0px; margin-bottom:0px; font-size:20px; list-style-type:disc;">
  <li style="margin-top:0px; margin-bottom:0px; font-size:20px; list-style-type:disc; line-height:1.5;">Have received the <a href="/health/vtsg">full regimen of WHO EUL vaccines</a> <b>at least 14 days before arriving in Singapore</b>. Vaccines requiring 2 doses must be completed either using the same or different brands and taken based on the recommended intervals between each dose.
