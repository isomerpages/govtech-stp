...
<b>Note:</b> The <b>approved arrival date</b> is the middle date stated on the entry approval letter. E.g. if the helper/CN is allowed to enter Singapore from 1 May to 3 May, the approved arrival date is 2 May.
