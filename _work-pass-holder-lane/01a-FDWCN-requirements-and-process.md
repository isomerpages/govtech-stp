...
<tbody>
  <tr>
    ...
    <td style="font-size:16px;border-right:1px solid #D8D8D8; border-bottom:2px solid #D8D8D8; ">Either the employer or employment agent can submit the application <a href="https://eservices.ica.gov.sg/STO/">here</a>. Please note the following regarding the application portal:
<ul>      
<li>For the best user experience, use Google Chrome (version 84 or later) or Microsoft Edge Web Browser to access the portal.</li>
<li>Additional step for employment agents: To use the portal, please get your CorpPass administrator to add the ‘Safe Travel Portal’ eService to your CorpPass account and assign you with access rights.</li>
<li>For more details, please refer to our <a href="/faq/tech#GenTechQuery">technical FAQs</a>.</li>
</ul>
...
<ol style="margin-top:0px;">
  <li style="font-size:16px; margin-top:10px; margin-bottom:0px;  line-height:1.5;">Secure the FDW/CN’s SHN accommodation if she is not required to serve SHN at a <a href="/health/shn/sdf" target="_blank">SHN-Dedicated Facility (SDF)</a>:</li>
    <ul>
