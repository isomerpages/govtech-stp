...
<ol style="margin-top:0px; margin-bottom:0px; font-size:20px; list-style-type:disc;">
  ...
  <li style="margin-top:15px; margin-bottom:0px; font-size:20px; list-style-type:disc; line-height:1.5;">Have received 1 dose of a PSAR-approved vaccine if they had earlier recovered from a COVID-19 infection. The vaccination should be taken no earlier than 3 months from the date of their diagnosis, if they had not already completed vaccination previously.</li>
