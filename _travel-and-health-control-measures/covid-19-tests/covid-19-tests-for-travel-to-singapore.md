 ...
 <thead>
    <tr>
	 ...
	 <tr>
      ...
      <td style="font-size:20px; margin-top:0px; margin-bottom:0px;border-right:2px solid #E0E0E0;border-bottom:2px solid #E0E0E0;" colspan="2">Paid during application for entry into Singapore*<br/><br/><i>*For returning SC/PRs - Payment details to be advised</i></td>
    </tr>
	 <tr>
