...
<div style="padding:10px 10px 5px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; font-size:18px;">
<p style=" font-size:18px; margin-top:0px; margin-bottom: 20px; line-height:1.35;">If you are born before 2020 (i.e. above 2 years old) and had arrived in Singapore <b>via land checkpoint</b>, take an unsupervised self-administered Antigen Rapid Test (ART)<b> within 24 hours of arrival</b>. You can take the ART using a self-procured <a href="https://www.hsa.gov.sg/consumer-safety/articles/covid19_selftests" target="_blank">authorised ART kit</a>, or kit approved for use in the country/region of embarkment.</p>
...
<p style=" font-size:18px; margin-top:0px; margin-bottom: 20px; line-height:1.35;">Registration can be done with the help of a local private healthcare provider or Public Health Preparedness Clinic. If you are a Construction, Marine Shipyard or Process Sector (CMP worker) on Work Permit, S Pass or In-Principle Approval holder, you must register your overseas vaccination record within 7 days of arrival in Singapore. In all other cases, registration should be done within 30 days of arrival. </p>
