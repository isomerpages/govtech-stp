...
<ol style="font-size:18px; margin-bottom:0px; list-style-type:lower-roman">
	<li style="font-size:18px; margin-top:0px; margin-bottom:0px; line-height:1.5;"><a href="https://safetravel.changiairport.com/#/" target="_blank">Pre-register and pre-pay</a> for their on-arrival COVID-19 Polymerase Chain Reaction test (S$125) at Changi Airport. This is <b>different</b> from the SHN related tests paid during application for entry into Singapore. Travellers are required to book for the test before arrival. Without advance booking, travellers can expect delays in the administration of the test and departure from the checkpoints.</li>
