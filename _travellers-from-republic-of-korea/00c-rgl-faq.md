...
Please approach the ROK Business Travel Support Center ( <www.btsc.or.kr> / (+82) 1566-8110 / <btsc@kita.net>) for further details on the medical institutions at which pre-departure COVID-19 testing in the ROK can be conducted. [Note: Website only in Korean; enquiries in English can be made via phone or email.]
