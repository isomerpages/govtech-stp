...
<ol style="font-size:20px;">
  ...
  <li style="font-size:20px; list-style-type:decimal;"> A VTL (Sea) traveller must comply with the following conditions:
     <ol style="font-size:18px; list-style-type:upper-alpha;">
        ...
        <li style="font-size:18px; list-style-type:upper-alpha;">arrive in Singapore on a <a href="https://go.gov.sg/vtl-sea/overview#transport" target="_blank">designated VTL (Sea) ferry</a>;</li>
