...
<ol style="font-size:20px;">
  ...
  <li style="font-size:20px; list-style-type:decimal;"> A VTL (Sea) traveller must comply with the following conditions:
     <ol style="font-size:18px; list-style-type:upper-alpha;">
       ...
       <li style="font-size:18px; list-style-type:upper-alpha;"> undergo a COVID-19 Polymerase Chain Reaction (PCR) test or Antigen Rapid Test (ART) within 2 days<sup>3</sup> before the scheduled departure time of his/her ferry, at an internationally accredited laboratory, clinic or medical facility, and obtain a test result certificate in English stating the following:</li>
