...
<p style="font-size:18px; margin-top:15px; margin-bottom:15px; line-height:1.35;">* <i>SCs/PRs and eligible LTPHs may obtain an acceptance letter from the <a href="https://go.gov.sg/vcp-portal" target="_blank">Vaccination Check Portal</a> and present it in lieu of an accepted proof of vaccination. Short-Term Visitors and Work Permit Holders who have verified their vaccination certificates on the VCP should still produce a valid Vaccinated Travel Pass (VTP) to be eligible for travel on the VTL.</i></p>
