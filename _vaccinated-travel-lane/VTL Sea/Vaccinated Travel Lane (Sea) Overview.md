...
<p style="font-size:18px; margin-top:15px; margin-bottom:15px; line-height:1.35;">* <i>SCs/PRs and eligible MOM LTPHs may obtain an acceptance letter from the <a href="https://go.gov.sg/vcp-portal" target="_blank">Vaccination Check Portal</a> and present it in lieu of an accepted proof of vaccination.</i></p>
