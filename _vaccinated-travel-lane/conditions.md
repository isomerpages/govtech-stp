...
<ol style="font-size:20px;">
  ...
  <li style="font-size:20px; list-style-type:decimal;"> A VTL Traveller must comply with the following conditions:
     <ol style="font-size:18px; list-style-type:lower-alpha;">
       ...
       <li style="font-size:18px; list-style-type:lower-alpha;"> undergo a COVID-19 polymerase chain reaction (PCR) test [or Antigen Rapid Test (ART), for entry into Singapore from <b>11 Nov 2021, 2359hrs, SGT</b>]  within 48 hours <sup>2</sup> before the scheduled departure time of his/her flight, at an internationally accredited laboratory, clinic or medical facility, and obtain a test result certificate in English stating the following:</li>
