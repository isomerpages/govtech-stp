...
<div class="content" style="background-color:#edf4fa;">
	...
	<ol style="margin-top:0px; list-style-type: lower-latin;">
		<li style="font-size:18px; margin-top:10px; margin-bottom:0px; line-height:1.5;">Have only travelled to / transited via any VTL countries/regions below, Hong Kong, Macao, Mainland China, Taiwan and/or Singapore, in the last 14 consecutive days before departure for Singapore.
