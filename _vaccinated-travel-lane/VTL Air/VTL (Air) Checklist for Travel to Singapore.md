...
<div style="padding:5px 10px 5px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; font-size:18px;">
	...
	<p style="padding-left:0px; font-size:18px; line-height:1.4; margin-top:10px; margin-bottom:0px;"><span style="font-size:25px;  color:red;"><b>✕</b></span> &nbsp; The tests are not applicable to Children aged two and below in this calendar year (i.e. born in or after 2020)</p>
</div>
