...
<div style="padding:5px 10px 5px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; font-size:18px;">
	...
	<p style="font-size:18px; margin-bottom:10px; line-height:1.35; margin-top:20px;">Travellers are allowed to depart from the airport via any form of transportation (e.g. public bus, train, private transport, taxi or private hire car). However, they may only proceed with their activities after testing negative on their ART and submitting their result. Otherwise, they must immediately proceed to their place of accommodation and test negative before heading out. </p>
