...
<ol style="list-style-type:disc;">
	<li style="font-size:16px; margin-top:10px; margin-bottom:0px;line-height:1.3; color:red;">Travellers who have reached this page via search engine for the first time and are intending to enter Singapore are advised to use this  <a href="https://www.checkfirst.gov.sg/c/747b8567-273f-4193-a46e-fa1d06f47c16" target="_blank">self-help tool</a> if they have not done so already, to determine if they should be entering via the Vaccinated Travel Lane (VTL) or other travel arrangements. </li>
