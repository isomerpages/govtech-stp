...
<ol style="font-size:20px;">
  ...
  <li style="font-size:20px; list-style-type:decimal;"> A VTL (Air) traveller must comply with the following conditions:
     <ol style="font-size:18px; list-style-type:lower-alpha;">
	     ...
	     <li style="font-size:18px; list-style-type:lower-alpha;">have only travelled to / transited via any <a href="/vtl/requirements-and-process#countries">VTL (Air) countries/regions</a>, <a href="/shn-and-swab-summary" target="_blank">Category I countries/regions</a>,  the European Economic Area (EEA) <sup>2</sup> (from 16 Mar 2022, SGT), and/or Singapore, for the last 7 consecutive days<sup>3</sup> before departing for Singapore;</li>			 
       ...
       <li style="font-size:18px; list-style-type:lower-alpha;"> undergo a COVID-19 Polymerase Chain Reaction (PCR) test or Antigen Rapid Test (ART) within 2 days <sup>4</sup> before the scheduled departure time of his/her flight, at an internationally accredited laboratory, clinic or medical facility, and obtain a test result certificate in English stating the following:</li>
        <ol style="font-size:18px; list-style-type:lower-roman;">
          ...
          <li style="font-size:18px; list-style-type:lower-roman;">the date and time when the COVID-19 test was taken; and</li>
               ...
               <li style="font-size:18px; list-style-type:lower-alpha;">(for travellers entering <b>before 13 Mar, 2359hrs, SGT</b>)  take private transportation, taxi, or private hire car to and from the <a href="http://www.moh.gov.sg/covid-19/quick-test-centres-(qtcs)" target="_blank">Quick Test Centre (QTC) or Combined Test Centre (CTC)</a>, undergo a COVID-19 supervised self-administered ART at a within 24 hours of arrival in Singapore, and remain isolated at the declared place of accommodation until the test result is confirmed to be negative; or <br> (for travellers entering from <b>13 Mar, 2359hrs, SGT</b>) undergo a COVID-19 unsupervised self-administered ART within 24 hours of arrival in Singapore, and report their test result via https://www.sync.gov.sg before proceeding with their activities in Singapore;</li>
