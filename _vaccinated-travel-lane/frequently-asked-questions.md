...
<p style="line-height:1.5; margin-top:10px; margin-bottom:0px; font-size:18px;">If your Singapore vaccination records are tagged to an older identification (e.g. passport/FIN/IC) number, please click here to retag your records to your newer identification number. Once retagging is complete, please proceed to re-submit your VTP (Air) application.</p>
