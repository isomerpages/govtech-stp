...
<div style="padding:10px 10px 10px 10px; margin-bottom:0px; line-height:1.35; background-color:#d5d5d5; font-size:18px;">
<input class="box" type="checkbox" style="width:20px; height:20px; vertical-align:middle;" id="3B"><label class="box" for="3B">&nbsp;&nbsp;<b>A) Release from Self-Isolation</b></label></div>
<div style="padding:10px 10px 5px 10px; margin-bottom:10px; line-height:1.35; background-color:#f8f8f8; font-size:18px;">
...
<p style=" font-size:18px; margin-top: 0px; margin-bottom:10px; line-height:1.35;">Those who test positive for COVID-19 must follow the relevant recovery protocols and receive medical treatment as necessary, and the prevailing treatment charges will apply.
</p>
